...
export function PageHeader({
  ...
  return (
    <div className={`flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between ${isSection ? "mb-4" : "mb-5"}`}>
      <div className="min-w-0">
        ...
        {description && (
          <p className={isSection ? "mt-0.5 text-sm text-slate-500" : "mt-0.5 text-sm text-slate-600"}>
            {description}
          </p>
        )}
      </div>
