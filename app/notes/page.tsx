...
export default function NotesPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 flex">
      {/* Panel izquierdo (igual que en dashboard) */}
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-600 max-w-xl">
                Registra aquí análisis de errores, decisiones de diseño,
                configuraciones y cualquier información relevante de tus
                proyectos.
              </p>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Filtra por título, texto, cliente, módulo, scope o código de
                error.
              </p>
            </div>
            <input
