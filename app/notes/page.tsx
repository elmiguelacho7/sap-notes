        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-600 max-w-xl">
              Registra aquí decisiones, errores analizados, configuraciones y
              cualquier detalle importante relacionado con tus proyectos.
            </p>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Busca por título, texto, cliente, módulo, scope o código de error.
            </p>
          </div>
          <input
            type="text"
